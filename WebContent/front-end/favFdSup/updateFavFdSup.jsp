  		...
  		<div class="row">
  			<div class="col-12">
				<form method = "post" action = "<%=request.getContextPath()%>/favFdSup/favFdSup.do">						
					<jsp:useBean id="favFdSup" scope="page" class="com.favFdSup.model.FavFdSupService" />
						<div class="form-group">
						    <label>主廚編號</label>
						    <input type="text" readonly class="form-control" name="chef_ID" value="${favFdSupVO.chef_ID}" />
						</div>						
						<div class="form-group">
						    <label>食材供應商編號</label>
						    <input type="text" readonly class="form-control" name="food_sup_ID" value="${favFdSupVO.food_sup_ID}" />
						</div>
						<div class="form-group">
						    <label>食材供應商備註</label>
						    <textarea rows="3" cols="100" name="fav_fd_sup_note" class="form-control">${favFdSupVO.fav_fd_sup_note}</textarea>
						</div>
