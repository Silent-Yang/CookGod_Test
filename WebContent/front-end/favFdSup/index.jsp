...
<title>主廚喜愛食材供應商管理</title>
</head>
<body>

	<div class="card text-center" style="background-color: #D4E6F1">
		<div class="card-body">
			<h5 class="card-title">主廚喜愛食材供應商管理</h5>
			<p class="card-text">Index.jsp</p>
		</div>
	</div>

	<a class="btn btn-outline-success" href='addFavFdSup.jsp' role="button"
		style="width: 50%; float: left;">新增主廚喜愛食材供應商</a>
	<a class="btn btn-outline-success" href='listAllFavFdSup.jsp'
		role="button" style="width: 50%;">查詢所有主廚喜愛食材供應商</a>
