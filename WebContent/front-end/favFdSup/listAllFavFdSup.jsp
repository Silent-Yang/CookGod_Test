...
<%
	...
	List<FavFdSupVO> listAll = favFdSupSvc.getAll();
...
<title>List_All_Fav_Fd_Sup.jsp</title>
<style type="text/css">
table {
...
<body>
	...
	<div class="card text-center" style="background-color: #D4E6F1">
		<div class="card-body">
			...
			<p class="card-text">listAllFavFdSup.jsp</p>
		...
		<div class="row">
			<div class="col-12">
				<table>
					...
					<c:forEach var="favFdSupVO" items="${listAll}"
							...
							<td>
								<form method="post"
									...
									<input type="submit" value="編輯"> <input type="hidden"
										name="chef_ID" value="${favFdSupVO.chef_ID}"> <input
										type="hidden" name="food_sup_ID"
										value="${favFdSupVO.food_sup_ID}"> <input
