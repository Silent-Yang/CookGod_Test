	...
	<table id="table-1">
		<tr>
			<td>
				...
				<h4>
					<a href=<%=request.getContextPath()%>/back-end/dish/select_page.jsp"><img
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="forum_msg_con" size="45"
					value="<%= forumMsgVO.getForum_msg_con()%>" /></td>
			<tr>
				<td>留言狀態:</td>
				<td><input type="TEXT" name="forum_msg_status" size="45"
					value="<%= forumMsgVO.getForum_msg_status()%>" /></td>
			<tr>
				<td>會員編號:</td>
				<td><input type="TEXT" name="cust_ID" size="45"
					value="<%= forumMsgVO.getCust_ID()%>" /></td>
				</td>
		</table>

		<br> <input type="hidden" name="action" value="update"> <input
			type="hidden" name="forum_msg_ID"
			value="<%=forumMsgVO.getForum_msg_ID()%>"> <input
			type="hidden" name="forum_art_ID"
			value="<%=forumMsgVO.getForum_art_ID()%>"> <input
			type="hidden" name="forum_msg_start"
			value="<%=forumMsgVO.getForum_msg_start()%>"> <input
