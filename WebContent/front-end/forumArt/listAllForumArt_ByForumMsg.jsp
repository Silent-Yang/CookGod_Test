...
<jsp:useBean id="listAllForumArt_ByForumMsg" scope="request" type="java.util.Set<ForumMsgVO>" />
<jsp:useBean id="forumArt" scope="page" class="com.forumArt.model.ForumArtService"/>
...
<table>
	...
	<c:forEach var="forumMsgVO" items="${listAllForumArt_ByForumMsg}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
