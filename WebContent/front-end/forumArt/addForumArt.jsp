...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/forumArt/forumArt.do" name="form1" enctype="multipart/form-data">
<table>
...
<input type="hidden"  name="forum_art_status" value="A0">
