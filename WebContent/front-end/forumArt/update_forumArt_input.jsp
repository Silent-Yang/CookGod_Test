...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="forumArt.do" name="form1"
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="forum_art_name" size="45"
					value="<%=forumArtVO.getForum_art_name()%>" /></td>
			</tr>
			<tr>
				<td>文章照片:</td>
				<td><img id="preview_progressbarTW_img"
					src="<%=request.getContextPath()%>/forumArt/forumArt.do?forum_art_ID=${forumArtVO.forum_art_ID}"
					width="300" height="200" width="300" height="200" /><br> <input
					type="file" name="forum_art_pic"
					value="<%=forumArtVO.getForum_art_pic()%>" /><br></td>
			</tr>
			<tr>
				<td>文章內容:</td>
			...
			<tr>
				...
				<td><input type="TEXT" name="chef_ID" size="45"
					value="<%=forumArtVO.getChef_ID()%>" /></td>
			</tr>

			<tr>
				<td>文章狀態</td>
				<td><input type="radio" name="forumArtStatus" value="Shelf">發表
  ...
  if(input.files && input.files[0]){
    ...
    reader.readAsDataURL(input.files[0]);
		...
		<br> <input type="hidden" name="action" value="update"> <input
			type="hidden" name="forum_art_ID"
			value="<%=forumArtVO.getForum_art_ID()%>"> <input
			type="hidden" name="forum_art_start"
			value="<%=forumArtVO.getForum_art_start()%>"> <input
