...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='listAllFestDish.jsp'>List</a> all Reports. <br>
		<br></li>


		<li>
			<FORM METHOD="post" ACTION="festDish.do">
				<b>請輸入菜色編號 :</b> <input type="text" name="dish_ID"> <input
					type="hidden" name="action" value="getOne_For_Display"> <input
					type="submit" value="送出">
			</FORM>
		</li>

		<jsp:useBean id="festDishSvc" scope="page"
			class="com.festDish.model.FestDishService" />

		<li>
			<FORM METHOD="post" ACTION="festDish.do">
				<b>節慶料理編號 ::</b> <select size="1" name="dish_ID">
