...
<body bgcolor='white'>
	...
	<table>
		...
		<FORM METHOD="post"
			...
			<b>選擇菜色:</b> <select size="1" name="food_ID">
			...
			<tr>
				<td>食材數量:</td>
				<td><input type="TEXT" name="dish_f_qty" size="45"
					value="<%=dishFoodVO.getDish_f_qty()%>" /></td>
			</tr>
			<tr>
				<td>食材單位:</td>
				<td><input type="TEXT" name="dish_f_unit" size="45"
					value="<%=dishFoodVO.getDish_f_unit()%>" /></td>
			</tr>
	</table>
