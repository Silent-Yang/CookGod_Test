...
<html>
  ...
  <body>
	...
	<a class="btn btn-outline-success" href='<%=request.getContextPath()%>/front-end/chef/addChef.jsp' role="button" style="width:50%;float: left;">新增主廚</a>
	<a class="btn btn-outline-success" href='<%=request.getContextPath()%>/front-end/chef/listAllChef.jsp' role="button" style="width:50%;">查詢所有主廚</a>
	...
	<div class="container justify-content-center">
  		<div class="row">
  			<div class="col-12">	
				...
				<form method = "post" action="<%=request.getContextPath()%>/front-end/chef/listOneByChefID.jsp">
				...
				<form method = "post" action="<%=request.getContextPath()%>/front-end/chef/listAllByChefArea.jsp">
					<div class="input-group">
