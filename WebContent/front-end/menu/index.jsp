...
<html>
  ...
  <body>
	...
	<a class="btn btn-outline-success" href='<%=request.getContextPath()%>/front-end/menu/addMenu.jsp' role="button" style="width:50%;float: left;">新增套餐</a>
	<a class="btn btn-outline-success" href='<%=request.getContextPath()%>/front-end/menu/listAllMenu.jsp' role="button" style="width:50%;">查詢所有套餐</a>
	...
	<div class="container justify-content-center">
  		<div class="row">
  			<div class="col-12">	
				...
				<form method = "post" action="<%=request.getContextPath()%>/front-end/menu/listOneByMenuID.jsp">
					<div class="input-group mb-3">
						<input type="text" class="form-control" name="menu_ID" placeholder="請輸入套餐編號">
