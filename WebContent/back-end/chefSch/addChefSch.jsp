			...
			<div class="col-12">
				<form method="post" action="chefSch.do">
					<div class="form-group">
						<label>排程日期</label> <input name="chef_sch_date"
							class="form-control" id="sch_date" type="text" />${errMsgs.chef_sch_date}
					</div>
					...
					<div class="form-group">
						...
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio"
								name="chef_sch_status" value="0" checked> <label
								class="form-check-label"> 有空 </label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio"
								name="chef_sch_status" value="1"> <label
								class="form-check-label"> 沒空 </label>
						</div>
					</div>
