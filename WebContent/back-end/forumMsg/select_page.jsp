...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='listAllForumMsg.jsp'>List</a> all Dish. <br>
		<br></li>

		<jsp:useBean id="forumMsgSvc" scope="page"
			class="com.forumMsg.model.ForumMsgService" />

		<li>
			<FORM METHOD="post" ACTION="forumMsg.do">
				<b>選擇菜色:</b> <select size="1" name="forum_msg_ID">
