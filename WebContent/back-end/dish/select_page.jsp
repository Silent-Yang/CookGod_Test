	...
	<div id="main-wrapper" data-navbarbg="skin6" data-theme="light"
		...
		<div class="page-wrapper">
			<div class="page-breadcrumb">
				...
				<ul>
					<li><a href='AllDish.jsp'>菜色</a><br>
					<br></li>
					<li><a
						href='<%=request.getContextPath() %>/back-end/menuDish/listAllMenuDish.jsp'>套餐菜色</a><br>
					<br></li>
					<li><a
						href='<%=request.getContextPath() %>/back-end/dishFood/listAllDishFood.jsp'>菜色食材</a>
					</li>
					...
					<jsp:useBean id="menuDishSvc" scope="page"
						class="com.menuDish.model.MenuDishService" />
					...
					<li>
						<FORM METHOD="post"
							...
							<b>套餐菜色:</b> <select size="1" name="menu_ID">
								<c:forEach var="menuVO" items="${menuSvc.all}">
									<option value="${MenuVO.menu_ID}">${menuVO.menu_name}
								</c:forEach>
							</select> <input type="hidden" name="action" value="listDishs_ByMenu">
							<input type="submit" value="送出">
						</FORM>
					</li>
					...
					<li>
						<FORM METHOD="post"
							...
							<b>菜色食材:</b> <select size="1" name="dish_ID">
								<c:forEach var="dishVO" items="${dishSvc.all}">
									<option value="${dishVO.dish_ID}">${dishVO.dish_name}
								</c:forEach>
							</select> <input type="hidden" name="action" value="listFoods_ByDish">
							<input type="submit" value="送出">
						</FORM>
					</li>
				...
				<ul>
					<li><a
						href="<%=request.getContextPath() %>/back-end/dishFood/addDishFood.jsp">新增菜色食材</a>
					</li>
				</ul>
				<ul>
					<li><a
						href="<%=request.getContextPath() %>/back-end/menuDish/addMenuDish.jsp">新增套餐菜色</a>
					</li>
				</ul>
