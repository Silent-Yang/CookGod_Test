	...
	<div id="main-wrapper" data-navbarbg="skin6" data-theme="light"
		...
		<div class="page-wrapper">
			<div class="page-breadcrumb">
				...
				<FORM METHOD="post" ACTION="dish.do" name="form1"
					...
					<table>
						...
						<tr>
							...
							<td><img id="preview_progressbarTW_img"
								...
								width="300" height="200" /><br> <input
								id="progressbarTWInput" type="file" name="dish_pic" size="45"
								id="progressbarTWInput" value="<%=dishVO.getDish_pic()%>" /><br>
							</td>
  ...
  if(input.files && input.files[0]){
    ...
    reader.readAsDataURL(input.files[0]);
					...
					<input type="hidden" name="dish_ID"
						value="<%=dishVO.getDish_ID()%>"> <input type="hidden"
