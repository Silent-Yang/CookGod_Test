...
<html>
  ...
  <body>
	...
	<a class="btn btn-outline-success" href='addMenuOrder.jsp' role="button" style="width:50%;float: left;">新增一筆訂單</a>
	<a class="btn btn-outline-success" href='listAllMenuOrder.jsp' role="button" style="width:50%;">查詢所有訂單</a>
  			...
  			<div class="col-12">	
				...
				<form method = "post" action="menuOrder.do">
					<div class="input-group mb-3">
					  <input type="text" class="form-control" name="menu_od_ID" placeholder="請輸入訂單號碼">
