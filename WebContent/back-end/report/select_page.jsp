...
<body bgcolor='white'>
	...
	<ul>
		<li><a
			href='<%=request.getContextPath()%>/back-end/report/listAllReport.jsp'>List</a>
			all Reports. <br>
		<br></li>
		...
		<li>
			<FORM METHOD="post"
				...
				<b>輸入檢舉編號 :</b> <input type="text" name="report_ID"> <input
		...
		<li>
			<FORM METHOD="post"
				ACTION="<%=request.getContextPath()%>/report/report.do">
				<b>選擇檢舉編號 ::</b> <select size="1" name="report_ID">
		...
		<li>
			<FORM METHOD="post"
				ACTION="<%=request.getContextPath()%>/report/report.do">
				<b>選擇檢舉分類:</b> <select size="1" name="report_ID">
					<c:forEach var="reportVO" items="${reportSvc.all}">
