...
<body bgcolor='white'>
	...
	<FORM METHOD="post"
		...
		<table>
			...
			<tr>
				<th>選擇菜色:</th>
				<td><c:forEach var="menuDishVO" items="${dishSvc.all}"
						varStatus="sc">
						<input type="checkbox" name="dish_ID"
							value="${menuDishVO.dish_ID}">
						<a
							href="<%=request.getContextPath()%>/menuDish/menuDish.do?dish_ID=${menuDishVO.dish_ID}&action=getDish">${dishSvc.getOneDish(menuDishVO.dish_ID).dish_name}</a>
