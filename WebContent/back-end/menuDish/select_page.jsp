...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='listAllMenuDish.jsp'>List</a> all Dish. <br>
		<br></li>
		...
		<li>
			<FORM METHOD="post"
				...
				<b>選擇菜色:</b> <select size="1" name="menu_ID">
		...
		<li>
			<FORM METHOD="post" ACTION="forumMsg.do">
				<b>選擇員工姓名:</b> <select size="1" name="forum_msg_ID">
